...
const ROUTE_HEADERS: Record<string, { title: string; subtitle: string } | null> = {
    faq:      { title: 'Preguntas Frecuentes', subtitle: 'Resuelve tus dudas de forma rápida y sencilla.' },
    historial:{ title: 'Historial',            subtitle: 'Seguimiento de tus tickets anteriores.' },
    nuevo:    { title: 'Crear Ticket',          subtitle: 'Describe tu problema y te ayudaremos lo antes posible.' },
    ...
    return (
        <View style={[styles.container, { paddingTop: insets.top + 10 }]}>
            <View style={styles.left}>
                {routeHeader ? (
                    <>
                        <Text style={styles.routeTitle}>{routeHeader.title}</Text>
                        <Text style={styles.subText}>{routeHeader.subtitle}</Text>
                    </>
                ) : (
                    <>
