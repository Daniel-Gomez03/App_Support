...
import { View, Text, StyleSheet, TouchableOpacity, Dimensions, ActivityIndicator, FlatList, RefreshControl } from 'react-native';
                        ...
                        ListEmptyComponent={
                            <View style={styles.emptyContainer}>
                                <View style={styles.iconCircle}>
                                    <MaterialCommunityIcons name="clipboard-text-off-outline" size={width * 0.15} color="#3C6034" />
                                </View>
                                <Text style={styles.emptyTitle}>Sin tickets</Text>
                                <Text style={styles.emptySubtitle}>Aún no tienes tickets cerrados en tu historial.</Text>
                            </View>
                        }
                    />
                )}
