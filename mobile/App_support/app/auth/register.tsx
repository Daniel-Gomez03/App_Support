...
const STEP_INFO = [
  {
    ...
    description:
      "Ingresa tu información básica para crear tu cuenta. Tus datos serán utilizados de forma segura.",
  },
  {
    title: "Datos empresariales",
    description:
      "Proporciona la información requerida para verificar tu empresa de forma segura.",
  },
  {
    title: "Crear contraseña",
    description:
      "Establece una contraseña segura para garantizar la protección de tu cuenta.",
  },
];
...
export default function RegisterScreen() {
  ...
  const allPwValid =
    pwValidation.hasUpperCase &&
    pwValidation.hasLowerCase &&
  ...
  const checkWarranty = async () => {
    ...
    try {
      ...
      if (!result.exists) {
        ...
        setWarrantyMsg(
          `Número de ${typeName} no encontrado. Requiere validación manual para acceder a la aplicación.`,
        );
      } else {
        const newStatus: WarrantyStatus = result.is_expired
          ? "expired"
          : "valid";
      ...
      setWarrantyStatus("notfound");
      setWarrantyMsg(
        `Número de ${typeName} no encontrado. Requiere revisión manual.`,
      );
    }
  };
            ...
            >
              ...
              {step === 2 && (
                <>
                    ...
                    >
                      <Text
                        style={[
                          ...
                          verificationType !== "" &&
                            styles.dropdownTriggerSelected,
                        ]}
                      >
                        {verificationType === "factura"
                          ? "Número de Factura"
                          : verificationType === "serie"
                            ? "Número de Serie"
                  ...
                  {verificationType !== "" && (
                    <View style={styles.inputGroup}>
                      ...
                      {(warrantyStatus === "valid" ||
                        ...
                        <View
                          style={[styles.warrantyResult, styles.warrantyValid]}
                        >
                          <Ionicons
                  ...
                  >
                    <View
                      style={[
                        styles.policyCheckCircle,
                        policyAccepted && styles.policyCheckCircleActive,
                      ]}
                    >
                      {policyAccepted && (
                ...
                <>
                  ...
                  <View style={styles.inputGroup}>
                    ...
                    <View style={styles.validationList}>
                      {[
                        {
                          ok: pwValidation.hasUpperCase,
                          text: "La contraseña debe contener una Mayúscula",
                        },
                        {
                          ok: pwValidation.hasLowerCase,
                          text: "La contraseña debe contener una Minúscula",
                        },
                        {
                          ok: pwValidation.hasNumber,
                          text: "La contraseña debe contener un Número",
                        },
                        {
                          ok: pwValidation.hasSpecialChar,
                          text: "La contraseña debe contener un carácter especial",
                        },
                        {
                          ok: pwValidation.minLength,
              ...
              <TouchableOpacity
                style={[
                  ...
                  isStepDisabled && styles.primaryButtonDisabled,
                ]}
                onPress={handleNext}
