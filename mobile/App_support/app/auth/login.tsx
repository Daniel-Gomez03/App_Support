        ...
        <Animated.View style={{ transform: [{ translateY: panelEntranceAnim }] }}>
          ...
          <CurvedBorder>
            ...
            <View style={styles.inputGroup}>
              ...
              <TextInput
                style={[styles.inputLogin, { borderColor: getLoginBorderColor('email', email) }]}
            ...
            <View style={styles.inputGroup}>
              ...
              <View style={[styles.passwordContainer, { borderColor: getLoginBorderColor('password', password) }]}>
                <TextInput
                ...
                <TouchableOpacity onPress={() => setShowPassword(v => !v)}>
                  <Entypo name={showPassword ? 'eye' : 'eye-with-line'} size={22} color="#818896" />
                </TouchableOpacity>
              </View>
            </View>
