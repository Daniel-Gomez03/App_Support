  ...
  return (
    ...
    >
      <View style={s.cardTop}>
        <View style={[s.catIcon, dispositivo ? s.catIconDevice : s.catIconCode]}>
          {dispositivo ? (
            <FontAwesome5 name="cog" size={16} color="#3C6034" />
          ) : (
            <MaterialCommunityIcons name="code-tags" size={18} color="#3B82F6" />
          )}
        </View>
        ...
        {techs.length > 0 ? (
          <View style={s.techRow}>
            ...
            <Text style={s.techName}>
              {techs.length === 1 ? techs[0].nombre_completo : `${techs.length} técnicos`}
            </Text>
          </View>
        ) : (
          <View style={s.unassignedRow}>
            ...
            <Text style={s.unassignedText}>Sin técnico asignado</Text>
          </View>
        )}
...
const s = StyleSheet.create({
  ...
  list: { paddingHorizontal: width * 0.05, paddingBottom: 120, paddingTop: 16 },
  searchBox: {
    flexDirection: "row",
    alignItems: "center",
    gap: 8,
  ...
  catIconDevice: { backgroundColor: "#E8F5E9" },
  catIconCode: { backgroundColor: "#EFF6FF" },
  subject: {
    flex: 1,
  ...
  badgeText: { fontFamily: "Poppins-Bold", fontSize: width * 0.027 },
  description: {
    fontFamily: "Poppins-Regular",
  ...
  techImg: { width: "100%", height: "100%", borderRadius: 15 },
  techInitial: { justifyContent: "center", alignItems: "center" },
  techInitialText: {
    fontFamily: "Poppins-Bold",
    fontSize: 11,
    color: "#FFF",
