...
export const registerStyles = StyleSheet.create({
  ...
  // ── Contenedor blanco (ocupa todo el espacio bajo la cabecera) ───────────
  panelContainer: {
    flex:                 1,
  ...
  // ── Título + paso fijos sobre el scroll ───────────────────────────────────
  stickyHeader: {
